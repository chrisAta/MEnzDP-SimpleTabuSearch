# THE TABU SEARCH CLASS FROM SOLID https://github.com/100/Solid/blob/master/Solid/TabuSearch.py
# JUST HAVING IT HERE AS A GUIDE
    ...
    def run(self, verbose=True):
        ...
        for i in range(self.max_steps):
            ...
            while True:
                ...
                if neighborhood_best in self.tabu_list: #Instead of If State is Tabu, should be If Swap is Tabu, if Move is in Tabu List rather than if Solution in Tabu List
